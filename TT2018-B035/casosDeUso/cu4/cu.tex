...
%--------------------------------------
	\begin{UseCase}{CU4}{servicios Turísticos}{
		...
		\UCitem{Errores}{}
		\UCitem{Tipo}{Caso de uso Ternario}
...
%--------------------------------------
	\begin{UCtrayectoria} 
		...
		\UCpaso Despliega la pantalla \IUref{IU8}{Servicios Turisticos} con los servicios turísticos catalogados y una barra de busqueda para filtrar por nombre los servicios.
